...
from torn_sdk.resources._generated.property_async import GeneratedAsyncPropertyResourceMixin


class AsyncPropertyResource(GeneratedAsyncPropertyResourceMixin, AsyncResource[Property]):
