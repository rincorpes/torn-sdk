...
from torn_sdk.resources._generated.racing_async import GeneratedAsyncRacingResourceMixin


class AsyncRacingResource(GeneratedAsyncRacingResourceMixin, AsyncResource[Racing]):
