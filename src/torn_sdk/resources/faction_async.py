...
from torn_sdk.resources._generated.faction_async import GeneratedAsyncFactionResourceMixin


class AsyncFactionResource(GeneratedAsyncFactionResourceMixin, AsyncResource[Faction]):
