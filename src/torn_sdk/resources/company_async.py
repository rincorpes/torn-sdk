...
from torn_sdk.resources._generated.company_async import GeneratedAsyncCompanyResourceMixin


class AsyncCompanyResource(GeneratedAsyncCompanyResourceMixin, AsyncResource[Company]):
