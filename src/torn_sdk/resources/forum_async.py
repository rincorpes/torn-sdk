...
from torn_sdk.resources._generated.forum_async import GeneratedAsyncForumResourceMixin


class AsyncForumResource(GeneratedAsyncForumResourceMixin, AsyncResource[Forum]):
